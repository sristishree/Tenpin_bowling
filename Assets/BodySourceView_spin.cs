...
public class BodySourceView_spin : MonoBehaviour
{
    public GameObject g;
    ...
    void Start()
    {
        ...
        SCS = g.GetComponent<SliderControlSpin>();
    ...
    void Update()
    {
        ...
        foreach (var body in data)
        {
            ...
            if (body.IsTracked)
            {
                ...
                {
                    y = (float)System.Math.Round(10 + ((val - upper) * (20 / (upper - lower))));
                    SCS.Valuefun(y);
                    svp.Set(y.ToString());
                ...
                if (i == 1)
                {
                    ...
                    svp.Set("The final spin has been set to " + y);
                    StartCoroutine(corr());
                    //Change_by_index(3);
                }
